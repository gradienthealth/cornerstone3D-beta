...
import getOverlayPlaneModule from '../../wadouri/metaData/getOverlayPlaneModule'
import { getDirectFrameInformation } from '../../wadouri/combineFrameInstanceDataset';
import multiframeDataset from '../../wadouri/retrieveMultiframeDataset';
import {
...
} from '../../wadouri/metaData/extractPositioningFromDataset';
...
function metaDataProvider(type, imageId) {
  ...
  let url = parsedImageId.zipUrl;

  if (parsedImageId.frame) {
    url = `${url}&frame=${parsedImageId.frame}`;
  }
  if (parsedImageId.dicomFile) {
    url = url + '/' + parsedImageId.dicomFile;
  }
